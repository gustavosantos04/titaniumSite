...
const conversations = [
  {
    name: 'Nelter Santos', company: 'NGF Racing', initials: 'NS',
  ...
  {
    name: 'Gestão AAAU', company: 'Atlética Universitária', initials: 'AU',
  ...
  {
    name: 'Silvio Ricardo', company: 'Eletroser', initials: 'SR',
